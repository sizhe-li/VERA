...
if __name__ == "__main__":
    ...
    # 2. Construct model
    # ------------------------------------------------------------
    # x_shape = (C, H, W)  for each frame
    # Example: 4 channels (RGB + FlowMag / Depth / etc), 32×32 resolution
    x_shape = torch.Size([4, 32, 32])

    max_tokens = 8  # max temporal length you want to test
    external_cond_dim = 0  # no external conditioning for this test
