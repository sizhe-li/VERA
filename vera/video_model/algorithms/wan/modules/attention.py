...
try:
    ...
    warnings.warn("flash_attn_interface (FlashAttention v3) not able to be loaded.")
...
except (ModuleNotFoundError, ImportError, OSError, RuntimeError) as e:
    warnings.warn(f"flash_attn (FlashAttention v2) not able to be loaded: {e}")
