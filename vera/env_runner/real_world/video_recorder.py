...
#     img_transform: Callable[[np.ndarray], np.ndarray] | None = None,
...
class VideoRecorder:
    ...
    def start(self, file_path, start_time=None) -> None:
        if self.is_ready():
    ...
    def write_frame(self, img: np.ndarray, frame_time=None) -> None:
